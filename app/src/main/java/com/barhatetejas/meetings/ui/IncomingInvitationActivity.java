...
public class IncomingInvitationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageAccepted = findViewById(R.id.imageAcceptInvitation);
        ImageView imageRejected = findViewById(R.id.imageRejectInvitation);

        imageAccepted.startAnimation(bounce);
        imageRejected.startAnimation(bounce);
        ...
        String inviterToken = getIntent().getStringExtra(Constants.REMOTE_MSG_INVITER_TOKEN);

        //Response buttons
        imageAccepted.setOnClickListener(view -> {
            sendInvitationResponse(Constants.REMOTE_MSG_INVITATION_ACCEPTED, inviterToken);
        });
        imageRejected.setOnClickListener(view -> sendInvitationResponse(Constants.REMOTE_MSG_INVITATION_REJECTED, inviterToken));
